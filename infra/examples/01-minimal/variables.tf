...
variable "resource_group_name" {
  description = "Resource group to create for the automation account."
  type        = string
...
variable "vm_scopes" {
  description = "Resource IDs where the identity may manage VMs. Prefer resource groups over subscriptions."
  type        = list(string)
}
